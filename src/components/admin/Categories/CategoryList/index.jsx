...
import CategoryListItem from '@/components/admin/Categories/CategoryList/CategoryListItem';
...
function CategoryList({ categories }) {
  ...
  return (
    <div className='flex-1 bg-white text-gray-600 rounded overflow-hidden shadow-lg border'>
      ...
      {/* {addNewCategoryModal ? (
        <AddNewCategoryModal closeModal={setAddNewCategoryModal} />
      ) : null} */}

      <div className='mx-4 my-2'>
        <div className=' flex justify-between h-6  text-gray-600 font-medium'>
          <span className='px-2 text-sm font-semibold'>Kategoriler</span>
        </div>
        <div className='relative overflow-x-auto shadow-md sm:rounded-lg py-2 px-4'>
          <div className='flex items-center py-4 bg-white justify-between'>
            ...
            <button
              type='button'
              className='focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 mr-16 mt-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900'
              onClick={() => {
                setAddNewCategoryModal(true);
              }}
            >
              Yeni
            </button>
