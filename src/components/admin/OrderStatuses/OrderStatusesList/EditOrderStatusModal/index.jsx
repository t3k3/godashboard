...
import { editOrderStatuses } from '@/services/orderstatuses';

function EditOrderStatusModal(props) {
  const [orderstatus, setOrderStatus] = useState(props.editOrderStatus);
  ...
  const handleSubmit = async (e) => {
    ...
    const res = editOrderStatuses(data, orderstatus.ID);
                      ...
                      <div className='flex flex-wrap  -mx-3 mb-6'>
                        <div className=' px-3 w-full mb-6 md:mb-0'>
                          ...
                          <input
                            ...
                            name='name'
                            type='text'
                            placeholder='Sipariş Durumu İsmi'
