...
function OrderStatusListItem({
  orderstatus,
  handleDeleteOrderStatus,
  handleOrderStatusEdit,
}) {
  return (
    <>
      <tr className='bg-white border-b  hover:bg-gray-200'>
        <td className='w-4 p-4'>
          <div className='flex items-center'>#{orderstatus.ID}</div>
        </td>
        ...
        >
          <div className='pl-3'>
            <div className='text-base font-semibold'>{orderstatus.name}</div>
            <div className='font-normal text-gray-500'>
              <span className='text-xs'>{orderstatus.name}</span>
            </div>
          </div>
        </th>
        ...
        <td className='px-6 py-1'>
          ...
          <div className='flex'>
            <svg
              ...
              onClick={() => {
                handleOrderStatusEdit(orderstatus);
              }}
            >
              <path
                strokeLinecap='round'
            ...
            <svg
              ...
              onClick={() => {
                handleDeleteOrderStatus(orderstatus.ID);
              }}
            >
              <path
                strokeLinecap='round'
