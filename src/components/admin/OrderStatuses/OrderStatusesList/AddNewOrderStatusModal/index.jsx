...
import { addNewOrderStatus } from '@/services/orderstatuses';

const orderstatusJSON = {
  name: '',
};

function AddNewOrderStatusModal(props) {
  const [orderstatus, setManufacturer] = useState(orderstatusJSON);
  ...
  const handleSubmit = async (e) => {
    ...
    const res = addNewOrderStatus(data);
                      ...
                      <div className='flex flex-wrap  -mx-3 mb-6'>
                        <div className=' px-3 w-full mb-6 md:mb-0'>
                          ...
                          <input
                            ...
                            name='name'
                            type='text'
                            placeholder='Sipariş Durumu Adı'
...
export default AddNewOrderStatusModal;
