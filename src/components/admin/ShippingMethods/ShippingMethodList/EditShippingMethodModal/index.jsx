...
import { editShipping, getSingleShippingMethod } from '@/services/shipping';

function EditShippingMethodModal(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    //   method: 'POST',
    //   mode: 'no-cors',
    //   url: `http://demo.actsistem.com/api/v1/admin/index.php?route=extension/shipping/${props.shippingMethodData.edit}`,
    //   data: shippingMethod,
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          ...
                          className='cursor-pointer mt-3 inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-red-500 sm:mt-0 sm:w-auto'
                        >
                          Kapat
                        </span>
                      </div>
...
export default EditShippingMethodModal;
