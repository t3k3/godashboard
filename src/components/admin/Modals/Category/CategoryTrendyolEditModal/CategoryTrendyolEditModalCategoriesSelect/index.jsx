...
function CategoryTrendyolEditModalCategoriesSelect({
  product,
  selected,
  setSelected,
}) {
  ...
  return (
    <div className='w-full px-3 font-medium h-15'>
      ...
      <div
        ...
        className={`bg-gray-200 border  w-full shadow p-2 flex items-center justify-between rounded ${
...
export default CategoryTrendyolEditModalCategoriesSelect;
