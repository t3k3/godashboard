...
function EditEftPaymentMethodModal(props) {
                      ...
                      <div className=' flex-wrap   mb-6'>
                        <div className='flex flex-wrap  mb-6'>
                          <div className='w-full px-3'>
                            ...
                            <textarea
                              value={paymentMethod?.bank_transfer_bank5}
                              type='text'
                              rows='4'
                              name='bank_transfer_bank5'
                              className='block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                              placeholder='Ödeme Sayfasında Görünecek Hesap Numaraları...'
                        ...
                        <div className='w-2/1 px-3 mb-6 mt-4 md:mb-0'>
                          ...
                          <select
                            ...
                            value={paymentMethod?.bank_transfer_status}
                            onChange={handleChange}
                          >
...
export default EditEftPaymentMethodModal;
