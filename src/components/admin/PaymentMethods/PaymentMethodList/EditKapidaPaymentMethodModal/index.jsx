...
function EditKapidaPaymentMethodModal(props) {
                    ...
                    >
                      <div className=' flex-wrap   mb-6'>
                        <div className=' px-3 w-2/1 mb-6 md:mb-0'>
                          ...
                          >
                            MİNİMUM TOPLAM SİPARİŞ TUTARI
                          </label>
                          <input
                            value={paymentMethod?.cod_total || ''}
                            ...
                            name='cod_total'
                            type='text'
                            placeholder='Minimum Toplam Sipariş Durumu...'
                        ...
                        <div className='w-2/1 px-3 mb-6 md:mb-0'>
                          ...
                          <select
                            ...
                            name='cod_order_status_id'
                            value={paymentMethod?.cod_order_status_id}
                            onChange={handleChange}
                          >
                        ...
                        <div className='w-2/1 px-3 mb-6 mt-4 md:mb-0'>
                          ...
                          <select
                            className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 '
                            name='cod_status'
                            value={paymentMethod?.cod_status}
                            onChange={handleChange}
                          >
...
export default EditKapidaPaymentMethodModal;
