...
function ProductListArea({ products }) {
  if (products?.length < 1) {
    console.log('URUN YOK');
    ...
    <div className='col-span-3'>
      ...
      <div className='flex items-center mb-4'>
        <select className='w-44 text-sm text-gray-600 px-4 py-3 border-gray-300 shadow-sm rounded focus:ring-primary focus:border-primary'>
          ...
          <option value=''>Eklenme Tarihi</option>
          <option value=''>Fiyat Yüksekten</option>
          <option value=''>Fiyat Düşükten</option>
        </select>
      ...
      <div className='grid md:grid-cols-3 grid-cols-2 gap-6'>
        ...
        <div className='bg-white shadow rounded overflow-hidden group'>
          ...
          <div className='pt-4 pb-3 px-4'>
            ...
            <div className='flex items-baseline mb-1 space-x-2 font-roboto'>
              <p className='text-xl text-primary font-semibold'>₺1599.00</p>
              <p className='text-sm text-gray-400 line-through'>₺2199.00</p>
            </div>
        ...
        <div className='bg-white shadow rounded overflow-hidden group'>
          ...
          <div className='pt-4 pb-3 px-4'>
            ...
            <div className='flex items-baseline mb-1 space-x-2 font-roboto'>
              <p className='text-xl text-primary font-semibold'>₺4599.00</p>
              <p className='text-sm text-gray-400 line-through'>₺5199.00</p>
            </div>
            <div className='flex items-center'>
              <div className='flex gap-1 text-sm text-yellow-400'>
                <svg
